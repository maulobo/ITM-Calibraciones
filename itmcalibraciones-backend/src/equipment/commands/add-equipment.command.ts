...
export class AddEquipmentCommand implements ICommand {
  constructor(public readonly addEquipmentDTO: AddEquipmentDTO) {}
}

@CommandHandler(AddEquipmentCommand)
export class AddEquipmentCommandHandler
  implements ICommandHandler<AddEquipmentCommand>
{
  constructor(
