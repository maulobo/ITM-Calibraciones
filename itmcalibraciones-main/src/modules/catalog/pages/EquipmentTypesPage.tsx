...
export const EquipmentTypesPage = () => {
  ...
  const { register, handleSubmit, reset, formState: { errors } } = useForm<CreateEquipmentTypeDTO>();
    ...
    <Box sx={{ p: 3 }}>
                ...
                {types?.length === 0 ? (
                  <TableRow>
                    <TableCell colSpan={3} align="center" sx={{ py: 8 }}>
                      <Typography color="text.secondary">No hay tipos definidos aún</Typography>
                    </TableCell>
                  </TableRow>
                ) : (
                  types?.map((item) => (
      ...
      >
        <DialogTitle sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", pb: 1 }}>
          <Typography variant="h6" fontWeight="bold">Nuevo Tipo</Typography>
